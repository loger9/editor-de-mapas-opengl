...
(define-type world (tile-vector unprintable:) (collision-vector unprintable:) vertex-vector key-state drawform)
(define tile-size 16.)
...
(define (insert-section-png x y width height i j world)
  (world-vertex-vector-set! world 
                            (f32vector-append (world-vertex-vector world) 
                                    (f32vector 
                                     x y (* 0.0625 i) (+ (* 0.0625 j) 0.0625)
                                     x (+ y height) (* 0.0625 i)  (+ (+ (* 0.0625 j) 0.0625) 0.0625)
                                     (+ x width) (+ y height) (+ (* 0.0625 i) 0.0625) (+ (+ (* 0.0625 j) 0.0625) 0.0625)
                                     (+ x width) y (+(* 0.0625 i) 0.0625) (+ (* 0.0625 j) 0.0625)))))

(define (set-column-vector vector column type)
  (let recur ((counter 0))
    (cond
     ((eq? counter 47) #t)
     (else
      (vector-set! (vector-ref vector counter) column type)
      (recur (+ counter 1))))))
  ...
  (let recur ((counter1 0) (counter2 0))
    (cond
     ((and (eq? counter1 46) (eq? counter2 79))
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size)  size size 0. 2. world))
     ((eq? (vector-ref (vector-ref vec counter1) counter2) '0)
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size)  size size 2. 3. world)
      (if (eq? counter2 79) 
          (recur (+ counter1 1) 0)
          (recur counter1 (+ counter2 1))))
     ((eq? (vector-ref (vector-ref vec counter1) counter2) '1)
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size)  size size 0. 0. world)
      (if (eq? counter2 79) 
          (recur (+ counter1 1) 0)
          (recur counter1 (+ counter2 1))))
     ((eq? (vector-ref (vector-ref vec counter1) counter2) '2)
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size) size size 1. 0. world)
      (if (eq? counter2 79)
          (recur (+ counter1 1) 0)
          (recur counter1 (+ counter2 1))))
     ((eq? (vector-ref (vector-ref vec counter1) counter2) '3)
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size) size size 2. 0. world)
      (if (eq? counter2 79)
          (recur (+ counter1 1) 0)
          (recur counter1 (+ counter2 1))))
     ((eq? (vector-ref (vector-ref vec counter1) counter2) '4)
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size) size size 0. 1. world)
      (if (eq? counter2 79)
          (recur (+ counter1 1) 0)
          (recur counter1 (+ counter2 1))))
     ((eq? (vector-ref (vector-ref vec counter1) counter2) '5)
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size) size size 1. 1. world)
      (if (eq? counter2 79)
          (recur (+ counter1 1) 0)
          (recur counter1 (+ counter2 1))))
     ((eq? (vector-ref (vector-ref vec counter1) counter2) '6)
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size) size size 2. 1. world)
      (if (eq? counter2 79)
          (recur (+ counter1 1) 0)
          (recur counter1 (+ counter2 1))))
     ((eq? (vector-ref (vector-ref vec counter1) counter2) '7)
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size) size size 0. 2. world)
      (if (eq? counter2 79)
          (recur (+ counter1 1) 0)
          (recur counter1 (+ counter2 1))))
     ((eq? (vector-ref (vector-ref vec counter1) counter2) '8)
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size) size size 1. 2. world)
      (if (eq? counter2 79)
          (recur (+ counter1 1) 0)
          (recur counter1 (+ counter2 1))))
     ((eq? (vector-ref (vector-ref vec counter1) counter2) '9)
      (insert-section-png (* (exact->inexact counter2) size) (* (exact->inexact counter1) size) size size 2. 2. world)
      (if (eq? counter2 79)
          (recur (+ counter1 1) 0)
          (recur counter1 (+ counter2 1))))
           ...
           (let recur ((counter1 a) (counter2 b))
             (cond
              ((and (eq? counter1 c) (eq? counter2 d))
               (insert-section-png (pos1 counter2) (pos2 counter1) size size 0. 2. world))
              ((eq? (vector-ref (vector-ref vec counter1) counter2) '0)
               (insert-section-png (pos1 counter2) (pos2 counter1) size size 2. 3. world)
               (if (eq? counter2 d) 
                   (recur (+ counter1 1) 0)
                   (recur counter1 (+ counter2 1))))
              ((eq? (vector-ref (vector-ref vec counter1) counter2) '1)
               (insert-section-png (pos1 counter2) (pos2 counter1) size size 0. 1. world)
               (if (eq? counter2 d) 
                   (recur (+ counter1 1) 0)
                   (recur counter1 (+ counter2 1))))
              ((eq? (vector-ref (vector-ref vec counter1) counter2) '2)
               (insert-section-png (pos1 counter2) (pos2 counter1) size size 1. 0. world)
               (if (eq? counter2 d)
                   (recur (+ counter1 1) 0)
                   (recur counter1 (+ counter2 1))))
              ((eq? (vector-ref (vector-ref vec counter1) counter2) '3)
               (insert-section-png (pos1 counter2) (pos2 counter1) size size 2. 0. world)
               (if (eq? counter2 d)
                   (recur (+ counter1 1) 0)
                   (recur counter1 (+ counter2 1))))
              ((eq? (vector-ref (vector-ref vec counter1) counter2) '4)
               ...
               (if (eq? counter2 d)
                   ...
                   (recur counter1 (+ counter2 1))))
              ((eq? (vector-ref (vector-ref vec counter1) counter2) '5)
               (insert-section-png (pos1 counter2) (pos2 counter1) size size 1. 1. world)
               (if (eq? counter2 d)
                   (recur (+ counter1 1) 0)
                   (recur counter1 (+ counter2 1))))
              ((eq? (vector-ref (vector-ref vec counter1) counter2) '6)
               (insert-section-png (pos1 counter2) (pos2 counter1) size size 2. 1. world)
               (if (eq? counter2 d)
                   (recur (+ counter1 1) 0)
                   (recur counter1 (+ counter2 1))))
              ((eq? (vector-ref (vector-ref vec counter1) counter2) '7)
               ...
               (if (eq? counter2 d)
                   ...
                   (recur counter1 (+ counter2 1))))
              ((eq? (vector-ref (vector-ref vec counter1) counter2) '8)
               (insert-section-png (pos1 counter2) (pos2 counter1) size size 1. 2. world)
               (if (eq? counter2 d)
                   (recur (+ counter1 1) 0)
                   (recur counter1 (+ counter2 1))))
              ((eq? (vector-ref (vector-ref vec counter1) counter2) '9)
               (insert-section-png (pos1 counter2) (pos2 counter1) size size 2. 2. world)
               (if (eq? counter2 d)
                   (recur (+ counter1 1) 0)
                   (recur counter1 (+ counter2 1))))
              (else              
    ...
    (let ((win (SDL_CreateWindow
      ...
      (let ((screen-width (*->int screen-width*))
        ...
        (let* ((perspective-matrix (matrix:* (make-translation-matrix -1.0 1.0 0.0)
               ...
               (texture-image* (or (IMG_Load "assets/PlantillaPF1-test.png")
                               ...
                               (let* ((mouse-event* (SDL_Event-button event*))
                                 ...
                                 (cond
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '0))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '0)
                                   (vector-set! (vector-ref (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  'none)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '1))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '1)
                                   (vector-set! (vector-ref (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  'ground)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '2))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '2)
                                   (vector-set! (vector-ref (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  'ground)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '3))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '3)
                                   (vector-set! (vector-ref (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  'ground)
                                  (map-updater vertex-data world) )
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '4))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '4)
                                   (vector-set! (vector-ref (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  'ground)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '5))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '5)
                                   (vector-set! (vector-ref (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  'ground)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '6))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '6)
                                   (vector-set! (vector-ref (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  'ground)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '7))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '7)
                                   (vector-set! (vector-ref (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  'ground)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '8))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '8)
                                   (vector-set! (vector-ref (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  'spikes)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '9))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '9)
                                   (vector-set! (vector-ref (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  'goal)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '10))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '10)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'up) (eq? (world-key-state world) '11))
                                   (vector-set! (vector-ref (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size)))) (inexact->exact(floor (/ mouse-x tile-size)))  '11)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'left) (eq? (world-key-state world) '0))
                                   (vector-set! (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size))) (make-vector 80 '0))
                                   (vector-set! (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size))) (make-vector 80 'ground))
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'left) (eq? (world-key-state world) '1))
                                   (vector-set! (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size))) (make-vector 80 '7))
                                   (vector-set! (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size))) (make-vector 80 'ground))
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'left) (eq? (world-key-state world) '2))
                                   (vector-set! (world-tile-vector world) (inexact->exact(floor (/ mouse-y tile-size))) (make-vector 80 '1))
                                   (vector-set! (world-collision-vector world) (inexact->exact(floor (/ mouse-y tile-size))) (make-vector 80 'ground))
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'right) (eq? (world-key-state world) '0))
                                   (set-column-vector (world-tile-vector world) (inexact->exact(floor (/ mouse-x tile-size))) '0)
                                   (set-column-vector (world-collision-vector world) (inexact->exact(floor (/ mouse-x tile-size))) 'none)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'right) (eq? (world-key-state world) '1))
                                   (set-column-vector (world-tile-vector world)  (inexact->exact(floor (/ mouse-x tile-size))) '7)
                                   (set-column-vector (world-collision-vector world) (inexact->exact(floor (/ mouse-x tile-size))) 'ground)
                                   (map-updater vertex-data world))
                                  ((and (eq? (world-drawform world) 'right) (eq? (world-key-state world) '2))
                                   (set-column-vector (world-tile-vector world) (inexact->exact(floor (/ mouse-x tile-size))) '8)
                                   (set-column-vector (world-collision-vector world) (inexact->exact(floor (/ mouse-x tile-size))) 'spikes)
                                   (map-updater vertex-data world)))))
                              ((= event-type SDL_KEYDOWN)
                               ...
                               (let* ((kevt* (SDL_Event-key event*))
                                 ...
                                 (cond ((= key SDLK_ESCAPE)
                                       ...
                                       ((= key SDLK_7)
                                        (world-key-state-set! world '7))
                                       ((= key SDLK_8)
                                        (world-key-state-set! world '8))
                                       ((= key SDLK_9)
                                        (world-key-state-set! world '9))
                                       ((= key SDLK_F9)
                                        ...
                                        (map-updater vertex-data world))
                                       ((= key SDLK_F5)
                                        (call-with-output-file "level-two/level-two.dat" (lambda (f) (display (world-tile-vector world) f)))
                                        (call-with-output-file "level-two/level-collisions-two.dat" (lambda (f) (display (world-collision-vector world) f))))
                                       ((= key SDLK_F1)
                                        (map-divider '1 vertex-data world)
                                        (call-with-output-file "level-two/level-two-sector1.dat" (lambda (f) (display (world-vertex-vector world)  f))))
                                       ((= key SDLK_F2)
                                        (map-divider '2 vertex-data world)
                                        (call-with-output-file "level-two/level-two-sector2.dat" (lambda (f) (display (world-vertex-vector world) f))))
                                       ((= key SDLK_F3)
                                        (map-divider '3 vertex-data world)
                                        (call-with-output-file "level-two/level-two-sector3.dat" (lambda (f) (display (world-vertex-vector world) f))))
                                       ((= key SDLK_F4)
                                        (map-divider '4 vertex-data world)
                                        (call-with-output-file "level-two/level-two-sector4.dat" (lambda (f) (display (world-vertex-vector world) f))))
                                       (else
